...
const InputComponent = () => {
  ...
  const handleSend = (event) => {
    ...
    setItems([...items, { "author": "triman", "message": inputValue, "timestamp": Date.now() }]);
  ...
  const EmojiInputter = () => {
    ...
    return (
      <main>
        ...
        <div class="flex flex-col items-center overflow-y-auto h-[80vh] w-[80vw] mx-auto p-5">
          {items.map(item => (
            <Bubble item={item}/>
          ))}
        </div>
        ...
        <div class="flex fixed inset-x-0 bottom-5 bg-gray-950 text-white mx-auto w-[80vw] flex-row gap-2 rounded-[99px] border border-gray-900/10 bg-gray-900/5 p-4">
          <div class="flex">
            <button
          ...
          <div class="relative grid h-full w-full min-w-[200px]">
            <textarea
              ...
              class="peer h-full  min-h-full w-full resize-none rounded-[7px]  !border-0 border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder:text-blue-gray-300 placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-transparent focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
...
const Bubble = ({item}) => {
  ...
  return(
    ...
    {/* Bubble */}
    <div class={`p-4 ${color} rounded-lg align`}>
